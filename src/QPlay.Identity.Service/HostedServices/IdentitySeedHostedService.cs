...
public class IdentitySeedHostedService : IHostedService
{
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        ApplicationUser adminUser = await userManager.FindByEmailAsync(identitySettings.AdminUserEmail);
    ...
    private static async Task CreateRoleIfNotExistsAsync(string roleName, RoleManager<ApplicationRole> roleManager)
    {
